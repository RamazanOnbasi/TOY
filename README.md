This grammar is for an imaginary programming language called “TOY” that only allows arithmetic operations and print statements. Figure 1 shows a complete program written in this language.
